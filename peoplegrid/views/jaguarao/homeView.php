                       ...
                       foreach ($projetos as $projeto){
                           ?>
                             <div class="span3 ">
                                ...
                                <a href="#projeto<?=$projeto->id?>"><button class="btn btn<?switch ($projeto->id){case 1: echo '-success';break;case 2: echo '-warning';break;case 3: echo '-danger';break;case 4: break;}?>"><?=lang('horizonteLerMais')?></button></a>
                            </div>  
